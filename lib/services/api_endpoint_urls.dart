class APIEndpointUrls {
  //static const String baseUrl = 'http://192.168.80.145:8082/';
  // static const String baseUrl = 'http://192.168.80.176:8082/';
  // static const String socket_url = 'http://192.168.80.145:8082';

  // static const String baseUrl = 'http://192.168.80.192:8082/';
  // static const String socket_url = 'http://192.168.80.192:8082/';


  static const String baseUrl = 'https://api.sympl.in/';
  static const String socket_url = 'https://api.sympl.in/';
  static const String apiUrl = 'api/app/';
  static const String webapiUrl = 'api/web/';
  ...
  static const String get_price_range = '${apiUrl}get-price-ranges';
  static const String get_city = '${apiUrl}get-all-cities';
  static const String get_area = '${apiUrl}get-areas';
  ...
  static const String get_variant_fields = '${apiUrl}get-variant-fields';
  static const String create_listing_by_user =
      '${apiUrl}create-listing-by-user';
  static const String verify_kyc = '${webapiUrl}digilocker/verify-kyc';
  static const String get_boost_plan = '${apiUrl}get-boost-plans';
  static const String toggle_pin_user = '${apiUrl}toggle-pin-user';
  static const String generate_description = '${apiUrl}generate-description';
  static const String request_digilocker = '${webapiUrl}digilocker/kyc';
  static const String brands_by_subcategory =
      '${apiUrl}get-brands-by-subcategory';
  static const String model_by_brands = '${apiUrl}get-brand-models';
  static const String create_listing = '${apiUrl}create-listing-by-user';
}
